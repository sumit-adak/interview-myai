            ...
            <main className="flex-1 md:ml-64 p-6 md:p-10 lg:p-12 overflow-y-auto w-full relative pt-20 md:pt-10">
                <div className="max-w-[1440px] mx-auto h-full flex flex-col lg:flex-row gap-8 lg:gap-12">
                        ...
                        <div className="space-y-6 glass-card p-6 md:p-8 rounded-xl flex-1 border border-[#334155] relative overflow-hidden">
                                ...
                                <div className="flex flex-wrap gap-2 mt-2.5">
                                    {ROLE_SUGGESTIONS.slice(0, 5).map((r) => (
                                        <button
                                            ...
                                            className={`text-[12px] font-['JetBrains_Mono'] px-2.5 py-1 rounded-md border transition-all ${
                                                currentRole === r
                                                    ? 'border-[#b8c8e0] bg-[#b8c8e0]/15 text-[#b8c8e0] font-semibold'
                                                    : 'border-[#334155] bg-[#1E293B]/60 text-[#c4c6cd] hover:border-[#b8c8e0]/50'
                                            }`}
                                        >
                                            {r}
                                        </button>
                                    ...
                                    {['Beginner', 'Intermediate', 'Experienced'].map((lvl) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`py-2.5 rounded-lg font-['JetBrains_Mono'] text-[13px] font-medium transition-all ${
                                                    isActive
                                                        ? 'bg-[#b8c8e0]/10 border border-[#b8c8e0] text-[#b8c8e0] font-semibold shadow-sm'
                                                        : 'bg-[#1E293B] border border-[#334155] text-[#c4c6cd] hover:text-[#dae2fd] hover:border-[#b8c8e0]/50'
                                                }`}
                                            >
                                                {lvl}
                                            </button>
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full bg-[#1E293B] border border-[#334155] rounded-lg py-3 px-4 text-[#dae2fd] font-['Inter'] text-[15px] input-glow cursor-pointer"
                                >
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-2">
                                    ...
                                    <span className="font-['JetBrains_Mono'] text-[13px] text-[#b8c8e0] font-bold">
                                ...
                                <input
                                    ...
                                    className="w-full accent-[#b8c8e0] h-1.5 bg-[#171f33] rounded-lg appearance-none cursor-pointer"
                                    max="100"
                                    min="1"
                                    type="range"
                                />
                                    ...
                                    {[15, 30, 45, 60].map((mins) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`px-5 py-2 rounded-full font-['JetBrains_Mono'] text-[13px] font-medium transition-all ${
                                                    isActive
                                                        ? 'border border-[#b8c8e0] bg-[#b8c8e0]/10 text-[#b8c8e0] font-bold shadow-sm'
                                                        : 'border border-[#334155] bg-[#1E293B] text-[#c4c6cd] hover:border-[#b8c8e0]/60'
                                                }`}
                                            >
                                                {mins}
                                            </button>
                    ...
                    <div className="w-full lg:w-[420px] flex flex-col gap-6">
                        <div className="glass-card rounded-xl p-6 md:p-8 border border-[#334155] flex-1 flex flex-col relative overflow-hidden">
                            <div
                                className="absolute inset-0 opacity-10 pointer-events-none"
                                style={{ backgroundImage: "radial-gradient(circle at top right, #b8c8e0, transparent 70%)" }}
                            ></div>

                            <h3 className="font-['Hanken_Grotesk'] text-[22px] font-bold text-[#dae2fd] mb-6 z-10 flex items-center gap-2">
                                <span className="material-symbols-outlined text-[#b8c8e0]">analytics</span>
                                Session Preview
                            </h3>

                            <div className="space-y-4 z-10 flex-1">
                                {/* Target Role */}
                                <div className="bg-[#1E293B]/80 p-4 rounded-lg border border-[#334155] border-l-2 border-l-[#b8c8e0] transition-all">
                                    <p className="font-['JetBrains_Mono'] text-[11px] text-[#c4c6cd] mb-1 uppercase tracking-wider">
                                        Target Role
                                    </p>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div className="bg-[#1E293B]/80 p-3.5 rounded-lg border border-[#334155]">
                                        <p className="font-['JetBrains_Mono'] text-[11px] text-[#c4c6cd] mb-1 uppercase tracking-wider">
                                            Level
                                        </p>
                                        <p className="font-['Inter'] text-[15px] font-medium text-[#b8c8e0]">
                                            {experience}
                                        </p>
                                    </div>
                                    <div className="bg-[#1E293B]/80 p-3.5 rounded-lg border border-[#334155]">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <div className="bg-[#1E293B]/80 p-3.5 rounded-lg border border-[#334155]">
                                        ...
                                        <p className="font-['Inter'] text-[14px] font-medium text-[#b8c8e0]">
                                ...
                                {/* AI Focus Areas */}
                                <div className="bg-[#1E293B]/80 p-4 rounded-lg border border-[#334155]">
                                    <p className="font-['JetBrains_Mono'] text-[11px] text-[#c4c6cd] mb-2.5 uppercase tracking-wider">
                                        AI Focus Areas
                                    </p>
                                    <div className="flex flex-wrap gap-2">
                                        {focusAreas.map((area, idx) => (
                                            <span
                                                key={idx}
                                                className="text-[12px] font-['JetBrains_Mono'] bg-[#171f33] px-2.5 py-1 rounded text-[#dae2fd] border border-[#334155]"
                                            >
                                                {area}
                                            </span>
                                        ))}
                            ...
                            <button
                                ...
                                className="w-full mt-6 glowing-btn font-['JetBrains_Mono'] text-[14px] font-bold py-4 rounded-lg flex items-center justify-center gap-2 z-10 magnetic cursor-pointer shadow-xl disabled:opacity-75"
                            >
                                {isStarting ? (
                                    <>
