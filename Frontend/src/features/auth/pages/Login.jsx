                ...
                <Card className="glass border-white/10 shadow-2xl">
                    ...
                    <form onSubmit={handleSubmit}>
                        <CardContent className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <Link className="text-xs text-primary hover:underline underline-offset-4" to="#">Forgot password?</Link>
                                </div>
                                <Input
                                    id="password"
                                    type="password"
                        ...
                        <CardFooter className="flex flex-col gap-4">
                            <Button className="w-full h-12 glow-magenta" type="submit" disabled={loading}>
                                {loading && <Loader2 className="mr-2 h-5 w-5 animate-spin" />}
                                Sign In
                            </Button>
                            <p className="text-sm text-center text-muted-foreground w-full">
                                Don't have an account?{" "}
                                <Link to="/register" className="text-primary hover:underline underline-offset-4 font-medium transition-colors">
                                    Sign up
                                </Link>
                            </p>
                        </CardFooter>
